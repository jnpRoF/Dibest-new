...
const MarketPlaceCard = ({ headText, bodyText, src, btnColor }) => {
  return (
    <div className="flex flex-col h-auto p-7 lg:p-6 lg:py-8 border rounded-md w-[90%] lg:h-[420px] lg:w-4/5 justify-between shrink-0 lg:translate-x-[20px] lg:flex-row">
      <>
        <img src={src} alt="" className="h-full w-full lg:w-[49%]" />
        <div className="flex flex-col space-y-4 lg:space-y-3 lg:h-full w-full lg:w-[49%]">
